...
if(isset($_POST["password_re"])){
    ...
    if($query){
        ...
        exit('<p style="color:   rgb(0, 41, 51);text-align: center;margin: 10%;font-size:x-large;">Password changed. You can now log in with your new password. <a href="login.html">Log In</a></p>');
