...
<body>
    ...
    <form action="edit_form.php" id="change_username" name="change_username" method="post">
        ...
        <div class="form-user">
            ...
            <input type="text" class="form-control" id="username_u" placeholder="username" name="username" required="">
        ...
        <div class="form-user">
            ...
            <input type="checkbox" id="check_u">Show Password
            <br>
    ...
    <form action="edit_form.php" id="change_password" name="change_password" method="post">
        ...
        <div class="form-user">
            <label for="username">Username:</label>
            <input type="text" class="form-control" id="username_p" placeholder="username" name="username" required="">
